...
train_data = pd.read_csv('datasets/train_modified_v4.csv')
...
ax1 = train_data.groupby("dayofweek").MEDIAN_VELOCITY.median().plot.line(figsize=(14,8), marker = 'o', title = 'Median Velocity vs Day of the Week')
...
ax2 = train_data.groupby("dayofweek").CUM_DIST.median().plot.line(figsize=(14,8), marker = 'o', title = "Distance Travelled vs Day of the Week")
...
ax3 = train_data.groupby("dayofweek").DURATION.median().plot.line(figsize=(14,8), marker = 'o', title = "Time Travelled vs Day of the Week")
